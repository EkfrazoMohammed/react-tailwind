...
const SignInComponent = ({handleLoginSuccess}) => {
  return (
      ...
      <div className="bg-gray-100 text-gray-500 p-4 rounded-3xl shadow-md w-full overflow-hidden max-w-[500px]">
        ...
        <div className="w-full">
          ...
          <div>
            ...
            <div className="flex">
              <div className="w-full px-3 mb-5">
                <button onClick={handleLoginSuccess} className="block w-full max-w-xs mx-auto bg-blue-500 hover:bg-blue-700 text-white rounded-lg p-2 font-semibold">Login</button>
              </div>
            </div>
